...
public class LocatedParseException extends ParseException {
   public LocatedParseException(LocatedParseException lpex, String file,
         int lineNumber) {
   ...
   static private String buildMessage(ParseException pex, String file,
         int lineNumber) {
      String message;
   ...
   static private String buildMessage(String message, String file,
         int lineNumber) {
      if (file == null) {
